...
var MyComboBoxItem = (function (_super) {
    __extends(MyComboBoxItem, _super);
    function MyComboBoxItem() {
        return _super.call(this) || this;
    }
    MyComboBoxItem.prototype.partAdded = function (partName, instance) {
        _super.prototype.partAdded.call(this, partName, instance);
    };
    MyComboBoxItem.prototype.childrenCreated = function () {
    ...
    MyComboBoxItem.prototype.dataChanged = function () {
    ...
    MyComboBoxItem.prototype.onTouchEnd = function (event) {
        var data = {};
        data["itemIndex"] = this.itemIndex;
        this.dispatchEventWith(MyComboBox.onClick, true, data);
    };
    return MyComboBoxItem;
}(eui.ItemRenderer));
__reflect(MyComboBoxItem.prototype, "MyComboBoxItem");
var MyComboBox = (function (_super) {
    __extends(MyComboBox, _super);
    function MyComboBox(data) {
    ...
    MyComboBox.prototype.updateData = function (key, value) {
        for (var i = 0; i < this.data.length; i++) {
            this.data[i][key] = value;
        }
    };
    MyComboBox.prototype.initPullView = function () {
        ...
        this.titleLabel.text = "MyComboBox";
        ...
        this.DataGroup.itemRenderer = MyComboBoxItem;
    ...
    MyComboBox.prototype.onRightIconBg = function (event) {
        if (!this.isPullDown) {
    ...
    MyComboBox.prototype.getTitleLabe = function () {
     ...
     *
     */
    MyComboBox.prototype.setItemWidth = function (width) {
        this.width = width;
        this.bg.width = width;
     ...
     *
     */
    MyComboBox.prototype.setItemHeight = function (height) {
        this.updateData("height", height);
    };
    /**
     * Set the title fontSize of the comboBox
     */
    MyComboBox.prototype.setItemFontSize = function (number) {
     ...
     *
     */
    MyComboBox.prototype.setTitleHeight = function (height) {
     ...
     */
    MyComboBox.prototype.setTitleBackground = function (src) {
        this.bg.source = src;
    };
    /**
     * Set the title fontSize of the comboBox
     */
    MyComboBox.prototype.setTitleFontSize = function (number) {
        this.titleLabel.size = number;
    };
    /**
     * Show the comboBox
     */
    MyComboBox.prototype.show = function () {
        this.isPullDown = true;
        //展开
        this.addChild(this.Scroller);
    };
     ...
     * Hidden the comboBox
     */
    MyComboBox.prototype.hide = function () {
        this.isPullDown = false;
        //收起
        this.removeChild(this.Scroller);
    };
     ...
     */
    MyComboBox.prototype.setItemTextAlign = function (align) {
        this.titleLabel.textAlign = align;
        this.updateData("textAlign", align);
    };
    //抛出事件
    MyComboBox.onClick = "MyComboBoxOnClick";
    return MyComboBox;
}(eui.Component));
__reflect(MyComboBox.prototype, "MyComboBox");
